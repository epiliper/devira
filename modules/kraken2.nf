process KRAKEN2 {
    ...
    def classified                  = meta.single_end ? "k2out/${prefix}.classified.fastq"   : "k2out/${prefix}.classified#.fastq"
    def unclassified                = meta.single_end ? "k2out/${prefix}.unclassified.fastq" : "k2out/${prefix}.unclassified#.fastq"
    ...
    def compress_reads_command      = "pigz -p $task.cpus k2out/*classified*.fastq"
